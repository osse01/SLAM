...
set key auto
set grid
plot "ekf_real.dat" with linespoints lw 2 pt 7 ps 0.5 title "EKF Trajectory", \
     "../data/mic_locations.txt" using 1:2 with points pt 9 ps 3 lc rgb "red" title "Microphones", \
